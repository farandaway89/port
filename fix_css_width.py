...
print("CSS Fixed!")
print("1. .nav-links a:hover::before - width: 100%")
print("2. .profile-image - width: 100%")
print("3. .btn-primary, .btn-secondary - width: 100%")
print("4. .social-item::before - width: 100%")
print("5. .experience-content - width: 100%")
