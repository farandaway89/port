...
# Create experienceData.ts
experience_data = """export interface ExperienceItem {
  id: number;
  title: string;
  company: string;
  period: string;
...
with open('C:/developer/port-website/portfolio-react/src/data/experienceData.ts', 'w', encoding='utf-8') as f:
    f.write(experience_data)

print("Created experienceData.ts")

# Create Experience.tsx
experience_component = """import { experienceData } from '../data/experienceData'
...
with open('C:/developer/port-website/portfolio-react/src/components/Experience.tsx', 'w', encoding='utf-8') as f:
    f.write(experience_component)

print("Created Experience.tsx")
